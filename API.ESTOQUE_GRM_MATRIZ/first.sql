...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20231013041205_firstMigration') THEN
...
BEGIN
    ...
    CREATE TABLE tab_estoque (
        ...
        "Ativo" boolean NOT NULL,
        "ClienteUltimaCompra1" text NULL,
        "CodigoClienteUltimaCompra1" text NULL,
        "ClienteUltimaCompra2" text NULL,
        "CodigoClienteUltimaCompra2" text NULL,
        "ClienteUltimaCompra3" text NULL,
        "CodigoClienteUltimaCompra3" text NULL,
        "Unidade" text NULL,
...
BEGIN
    ...
    CREATE TABLE tab_substitutos (
        "Id" integer GENERATED BY DEFAULT AS IDENTITY,
        "MaterialEstoqueId" integer NOT NULL,
        "SubstitutoId" integer NOT NULL,
...
BEGIN
    ...
    VALUES ('20231013041205_firstMigration', '7.0.5');
    END IF;
END $EF$;
COMMIT;
